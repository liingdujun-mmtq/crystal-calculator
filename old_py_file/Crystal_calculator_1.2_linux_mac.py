...
def main_window():
    root=tk.Tk()
    root.title('Crystal calculator by LingDuJun')
    icon_path=sys.argv[0]
    icon=PhotoImage(file=icon_path[0:-21]+"/logo.ico")
    root.tk.call('wm','iconphoto',root._w,icon)
    #root.icon('/home/tuanzi/Python/crystal-calculator/logo.png')
    # hkl
    ...
    tk.Button(Command, text = "Get d-list", command = get_d,width=15,height=3).grid(row = 0, column = 0)
